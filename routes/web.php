...
Route::post('/notify/overdue/' , 'NotificationController@sendNotification')->name('notify.overdue');
Route::get('/notify/history/' , 'NotificationController@history')->name('notify.history');
