...
<head>
    ...
    <link rel="stylesheet" href="{{asset('selectize/css/selectize.bootstrap3.css')}}"/>
</head>
<body class="{{ $class ?? '' }}">
<div class="wrapper">
    @auth
...
<script src="{{ asset('/selectize/js/standalone/selectize.js') }}" type="text/javascript"></script>
